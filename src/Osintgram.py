...
class Osintgram:
    ...
    # HELPER FUNCTIONS
    def _clear_cookies(self, clear_cookies):
        if clear_cookies:
            self.clear_cache()
    ...
    def _check_private_profile(self):
    ...
    def _get_comments(self, media_id):
        comments = []
    ...
    def _setTarget(self, target, show_output):
        self.target = target
